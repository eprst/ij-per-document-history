# IntelliJ per-document jump history
...
<!-- Plugin description -->
Changes `Back` and `Forward` actions to be per-document instead of global. Holding "Shift" while invoking them switches back to global.
